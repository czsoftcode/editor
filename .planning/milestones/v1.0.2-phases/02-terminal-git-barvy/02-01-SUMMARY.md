...
plan: 01
subsystem: ui
tags: [terminal, egui, egui_term, theme, scrollbar]
requires:
  - phase: 01-zaklad
    provides: runtime settings apply + visuals dark/light switching
provides:
...
affects: [terminal-ui, claude-panel, build-terminal, theme-switching]
tech-stack:
  added: []
  patterns: [visuals-driven theming, tdd-red-green]
key-files:
  created:
...
patterns-established:
  - "Terminálové barevné změny řešit čistě na render vrstvě (bez zásahu do PTY lifecycle)."
  - "Kontrastní helper testy pro light/dark varianty držet přímo u renderer/helper modulu."
