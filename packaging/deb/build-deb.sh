...
compute_depends() {
    ...
    # minimální runtime balíčky pro X11/Wayland/OpenGL.
    manual_depends="libx11-6, libxcb1, libxkbcommon0, libwayland-client0, libwayland-cursor0, libwayland-egl1, libegl1, libgl1"
