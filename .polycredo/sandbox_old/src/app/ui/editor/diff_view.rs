...
pub fn render_diff_modal(
    ...
    let modal =
        StandardModal::new(i18n.get("ai-diff-heading"), "ai_diff_modal").with_size(900.0, 650.0);
    ...
    modal.show(ctx, &mut show_flag, |ui| {
        ...
        modal.ui_body(ui, |ui| {
            ui.horizontal(|ui| {
                ui.label(i18n.get("ai-diff-heading"));
                ui.add_space(8.0);
                    ...
                    if side_by_side {
                        ...
                        egui::Grid::new("side_by_side_diff_grid")
                            ...
                            .show(ui, |ui| {
                                // Headers for columns
                                ui.label(
                                    egui::RichText::new("Original").strong().color(fg_removed),
                                );
                        ...
                        for change in diff.iter_all_changes() {
                            ...
                            ui.add(
                                egui::Label::new(layout_job).wrap_mode(egui::TextWrapMode::Extend),
                            );
                        }
                    }
                });
