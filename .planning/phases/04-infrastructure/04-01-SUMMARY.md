...
plan: 01
subsystem: ui
tags: [sandbox, settings, terminal, persistence, egui, rust]
...
affects: [settings, workspace, terminal]

tech-stack:
  added: []
  patterns:
    - "sandbox_mode_enabled v WorkspaceState jako stabilní zdroj pravdy (apply-on-reopen)"
...
patterns-established:
  - "Terminálový label a working dir se odvozují z sandbox_mode_enabled."

requirements-completed: [SETT-01, SETT-02, SETT-03, SETT-04, SETT-05, TERM-01, TERM-02, TERM-03]
