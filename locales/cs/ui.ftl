...
command-name-find = Najít
command-name-replace = Nahradit
command-name-goto-line = Přejít na řádek
command-name-command-palette = Příkazová paleta
...
project-search-panel-title = Vyhledávání v projektu
...
history-nav-older = Starší verze
history-nav-newer = Novější verze
history-current-label = Aktuální
history-historical-label = Historická
history-version-info = Verze z { $date }
history-restore-btn = ⟲ Obnovit
history-restore-confirm-title = Obnovit historickou verzi
...
# Modal volby otevření projektu
open-choice-title = Otevřít projekt
open-choice-description = Kde chcete projekt otevřít?
open-choice-new-window = Nové okno
open-choice-current-window = Stávající okno
open-choice-cancel = Zrušit
