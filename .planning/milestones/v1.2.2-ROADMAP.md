...
- ✅ **v1.2.2 Additional Themes** — Phases 27-29 (shipped 2026-03-11)
- ⏸️ **v1.2.2-dev GSD Integration + Slash Commands** — Phases 19-23 (slepá ulička, ignorovat v budoucnu)

---

## Phases

### v1.2.2 Additional Themes
...
- [x] 28-01-PLAN.md — Add Midnight dark variant (enum, colors, UI picker, i18n)
...
- Phase 19-23: GSD Integration + Slash Commands — slepá ulička, nepoužívat jako základ pro další plánování
...
|-------|-----------|----------------|--------|-----------|
| 27 | v1.2.2 | 2/2 | Complete | 2026-03-11 |
| 28 | v1.2.2 | 1/1 | Complete | 2026-03-10 |
| 29 | v1.2.2 | 2/2 | Complete | 2026-03-11 |
...
*Last updated: 2026-03-11 (v1.2.2 Additional Themes shipped)*
