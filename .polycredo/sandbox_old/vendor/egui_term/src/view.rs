...
impl<'a> TerminalView<'a> {
    ...
    fn process_input(
        ...
        // Pokud bylo levé tlačítko myši uvolněno mimo oblast terminálu,
        // is_dragged zůstane true a každý pohyb myši by spouštěl SelectUpdate.
        // Resetujeme ho hned na začátku každého snímku, pokud tlačítko není stisknuto.
