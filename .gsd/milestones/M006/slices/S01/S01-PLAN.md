...
- [ ] **T01: State rozšíření + panel skeleton + layout integrace** `est:45m`
...
- [ ] **T02: Výsledky + klik → jump + poll loop + replace flow** `est:60m`
...
- [ ] **T03: Keymap dispatch + smazání mrtvých modálů + i18n + cleanup** `est:45m`
