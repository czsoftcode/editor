# Requirements Archive: v1.2.2 Additional Themes
...
# Requirements: PolyCredo Editor v1.2.2
...
- [x] **THEME-05**: User can select 2nd dark theme variant in Settings (optional variant to existing dark)
- [x] **THEME-06**: 2nd dark theme is persisted across app restart in settings.toml
- [x] **THEME-07**: 2nd dark theme shows correctly in theme picker with visual swatch
...
| THEME-05 | Phase 28 | Complete |
| THEME-06 | Phase 28 | Complete |
| THEME-07 | Phase 28 | Complete |
| SYNTAX-01 | Phase 29 | Complete |
| SYNTAX-02 | Phase 29 | Complete |

**Coverage:**
- v1.2.2 requirements: 9 total
- Mapped to phases: 9
- Unmapped: 0
