...
## Панели
panel-files = Файлы
panel-files-tree = Проект
panel-files-changes = Изменения
...
settings-dark-variant = Тёмная вариация
...
history-restore-btn = ⟲ Восстановить
history-restore-confirm-title = Восстановить историческую версию
history-restore-confirm-text = Заменить текущее содержимое выбранной исторической версией? Текущее состояние будет сохранено как новая версия в истории.
history-restore-confirm-ok = Восстановить
history-restore-confirm-cancel = Отмена

# Replace preview dialog
project-search-replace-preview-title = Предпросмотр замены
project-search-replace-confirm = Подтвердить замену
project-search-replace-cancel = Отмена
project-search-replace-select-all = Выбрать все
project-search-replace-deselect-all = Снять выбор
project-search-replace-selection-info = { $selected } из { $total } выбрано
project-search-replace-success = Заменено в { $count } файлах
